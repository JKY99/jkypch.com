...
| Framework | Jakarta/Java EE | JDK | OSS 지원 | 상용 지원 | 대응 Boot |
|-----------|----------------|-----|---------|----------|----------|
| **7.0** | Jakarta EE 11 | 17+ | 2026-12 | 2027-12 | Boot 4.0 |
| **6.2** | Jakarta EE 10 | 17+ | 2026-06 | **2032-06** | Boot 3.5 (LTS) |
| 6.1 | Jakarta EE 10 | 17+ | 2025-06 | 2026-06 | Boot 3.3 |
| 6.0 | Jakarta EE 9+ | 17+ | 2024-06 | 2025-12 | Boot 3.0~3.2 |
| 5.3 | Java EE 8 (javax) | 8+ | 2024-12 | 2029-06 | Boot 2.7 |

> **핵심**: Framework 6.0부터 `javax.*` → `jakarta.*` 네임스페이스로 전환됨. 5.3 이하와 6.0 이상은 호환되지 않는 별개의 세계다.
